...
@endsection
@section('bawah')
<img class="img-fluid daftarpic" src="{{ asset('assets/layanan.svg') }}" alt="review" style="display:flex; margin:auto;width:175px">
<h5 style="color: #7FBCD2; text-align:center; justify-content:center">Pesanan: F-3024</h5>
<h3 style="color: #7FBCD2; text-align:center">Gimana pelayanannya?</h3>
