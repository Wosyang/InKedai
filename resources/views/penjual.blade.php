...
<body>
    <nav class="navbar navbar-expand-sm navbar-dark fixed-top" style="background-color: #7FBCD2;">
        <ul class="navbar-nav">
            <li class="nav-item">
                <a class="h4 nav-link" href="{{ url()->previous() }}" style="color: #ffffff">
                    <i class="fa-solid fa-caret-left fa-1x" style="color: #ffffff"></i> Back</a>
            </li>
            <li class="nav-item">
                <a class="h4 nav-link" href="{{ route('penjual.home') }}" style="color: #ffffff">
